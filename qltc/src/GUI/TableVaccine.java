...
public class TableVaccine extends JFrame {
	...
	public TableVaccine() {
		...
		JLabel lblNewLabel = new JLabel("Vaccine");
		lblNewLabel.setFont(new Font("Tahoma", Font.BOLD, 15));
		lblNewLabel.setBounds(391, 13, 90, 35);
		...
		dtmsach.addColumn("Mã Vaccine");
		dtmsach.addColumn("Tên Vaccine");
		dtmsach.addColumn("Mã Loại");
		dtmsach.addColumn("Mã NCC");
		dtmsach.addColumn("Mã Phiếu đ/k tiêm");
		dtmsach.addColumn("Năm SX");
		...
		btnLuu.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (i >= 0) {
					...
					if (MainFrame.pnPhieuTiem.isShowing()) {
						MainFrame.txtmaVaccineTiem.setText(masach);
					} else {
	...
	public void loadsach() {
		dtmsach.setRowCount(0);
		for (VaccineDTO sachitem : MainFrame.sach) {
			Vector<Object> vec = new Vector<Object>();
