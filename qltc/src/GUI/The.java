...
public class The extends JFrame {
	...
	public The() {
		...
		dtmthetv.addColumn("Mã Thẻ QL vắc-xin");
		dtmthetv.addColumn("Tên");
		dtmthetv.addColumn("Mã CCCD");
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if(i>-1) {
					...
					DTO.TestTheQuanLyDTO the = new DTO.TestTheQuanLyDTO(ma,madocgia,tendoc,ngaybatdau,ketthuc); 
					if(TestTheQuanLyBUS.gI().suatacgia(the) > 0 ) {
		...
		btnNewButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(i>-1) {
					...
					String ketthuc = sdf.format(date2);
					DTO.TestTheQuanLyDTO the = new DTO.TestTheQuanLyDTO(ma,madocgia,tendoc,ngaybatdau,ketthuc); 
					if(TestTheQuanLyBUS.gI().xoatacgia(the) > 0 ) {
		...
		JLabel lblNewLabel = new JLabel("Thẻ QLHT vắc-xin" ,SwingConstants.CENTER);
		...
		btnThm.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				String ketthuc = sdf.format(date2);
				DTO.TestTheQuanLyDTO the = new DTO.TestTheQuanLyDTO(ma,madocgia,tendoc,ngaybatdau,ketthuc); 
				if(TestTheQuanLyBUS.gI().themtacgia(the) > 0 ) {
		...
		JLabel lblNewLabel_1_1_2 = new JLabel("Tên Người Dân");
		lblNewLabel_1_1_2.setFont(new Font("Tahoma", Font.BOLD, 15));
		lblNewLabel_1_1_2.setBounds(12, 207, 97, 32);
		contentPane.add(lblNewLabel_1_1_2);
		setLocationRelativeTo(null);
		NguoiDan docgia = MainFrame.thethanhvien;
		DTO.TestTheQuanLyDTO tv = MainFrame.tv;
		if(tv.getMaTheThuVien() != 0 ) {			
			...
			try {
				...
				JOptionPane.showMessageDialog(null, "Chưa có thẻ HTQL vắc-xin");
			} 
	...
	public static ArrayList<DTO.TestTheQuanLyDTO> thetv = new ArrayList<DTO.TestTheQuanLyDTO>();

	public void loadctphieunhap() {
		thetv = null;
		
		thetv = TestTheQuanLyDAL.getdanhsachthongtinthethuvien();
		dtmthetv.setRowCount(0);

		for (DTO.TestTheQuanLyDTO pn : thetv) {
