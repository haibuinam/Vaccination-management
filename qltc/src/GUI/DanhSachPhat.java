...
public class DanhSachPhat extends JFrame {
	...
	public DanhSachPhat() {
		...
		dtmdsphat.addColumn("Mã Phiếu Trả Phí");
		dtmdsphat.addColumn("Mã Phiếu Tiêm");
		dtmdsphat.addColumn("Thông tin gói");
		dtmdsphat.addColumn("Số Tiền");
		table = new MyTable(dtmdsphat);
		scrollPane.setViewportView(table);
		
		JLabel lblNewLabel = new JLabel("DANH SÁCH TRẢ PHÍ");
		lblNewLabel.setFont(new Font("Tahoma", Font.BOLD, 15));
		lblNewLabel.setBounds(264, 13, 250, 53);
	...
	public static ArrayList<DTO.GoiTiemDTO> phat = new ArrayList<DTO.GoiTiemDTO>();

	public void loadphat() {
		phat = null;
		phat =GoiTiemBUS.gI().getdanhsachphat(); 

		dtmdsphat.setRowCount(0);

		for (DTO.GoiTiemDTO pn : phat) {
