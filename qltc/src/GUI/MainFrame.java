...
public class MainFrame extends JFrame {
	...
	public void menuleft() {
		...
		lblQuanLyTiem = new JLabel("Đơn vị quản lý ĐHBKHN");
		...
		lbltacgia = new JLabel("   Đăng Ký Tiêm");
		...
		lblphieutiem = new JLabel(" Phiếu Tiêm");
		...
		btnTm_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if (!isNumber(txttimsach.getText())) {
					JOptionPane.showMessageDialog(null, "Tìm Kiếm Theo Mã Vaccine");
					return;
				}
		...
		btnTm_2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (tg != null) {
					...
					JOptionPane.showMessageDialog(null, "Không tìm thấy nhà khoa học");
				}
			}
		});
		...
		lblNewLabel_1 = new JLabel("Mã PTiêm");
		...
		lblNewLabel_5 = new JLabel("Mã CCCD");
		lblNewLabel_5.setFont(new Font("Tahoma", Font.BOLD, 15));
		lblNewLabel_5.setBounds(12, 110, 97, 36);
		panel_3.add(lblNewLabel_5);

		lblNewLabel_6 = new JLabel("Ngày Tiêm");
		...
		btnthemphieuTiem = new JButton("Thêm");
		...
		btnsuaphieuTiem = new JButton("Sửa");
		...
		btnxoaphieuTiem = new JButton("Xoá");
		...
		btnreloadphieuTiem = new JButton("Tải Lại");
...
//luuu
		...
		dtmTiem.addColumn("Mã PTiêm");
		dtmTiem.addColumn("Mã Nhân Viên");
		dtmTiem.addColumn("Mã CCCD");
		dtmTiem.addColumn("Ngày Tiêm");
		dtmTiem.addColumn("Tình Trạng");

		tablemuon = new MyTable(dtmTiem);

		scrollPane_5.setViewportView(tablemuon);

		lbltimkiempt = new JLabel("Tìm Kiếm");
		...
		//fix
		dtmctpt.addColumn("Mã CTPhiếu tiêm");
		dtmctpt.addColumn("Mã PTiêm");
		dtmctpt.addColumn("Mã Vaccine");
		dtmctpt.addColumn("Ngày Tiêmi)");
		dtmctpt.addColumn("Ghi Chú");
		...
		JLabel lblNewLabel_8 = new JLabel("Mã Vaccine");
		...
		JLabel lblNewLabel_8_1 = new JLabel("Hạn theo dõi");
		...
		btnthemctptiem = new JButton("Thêm");
		...
		btnthemphieuphat = new JButton("Gói Trả Phí");
		...
		btnthemphieuphat.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				if (Ma == null || Ma.isEmpty() || Ma.equals("")) {
					JOptionPane.showMessageDialog(null, "Bạn chưa chọn mã phiếu tiêm");
					return;
				}
		...
		btndanhsachphat = new JButton("DS Trả Phí");
		...
		JButton btnTimphieTiem = new JButton("Tìm");
		...
		lblNewLabel_12 = new JLabel("Mã Vaccine");
		...
		dtmchitietphieunhap.addColumn("Mã Vaccine");
	...
	private void pnthongke() {
		...
		System.out.println("Tổng Vaccine" + tongVaccine);
		System.out.println("Vaccine Đã Tiêm " + Chitietptbus.gI().getsoluongsachdamuon());
		...
		System.out.println("Phần Trăm Vaccine đã tiêm :" + phantramVaccinedatiem);

		p.setValue("Vaccine Đã Tiêm ", phantramVaccinedatiem);
		p.setValue("Vaccine Còn Lại", 100 - phantramVaccinedatiem);

		JFreeChart chart = ChartFactory.createPieChart3D("Thống Kê Vaccine Đã Tiêm", p);

		TextTitle tt = new TextTitle("Thống Kê Vaccine Đã Tiêm", new Font("Arial", Font.BOLD, 15));
		...
		dtmthongkenhaphang.addColumn("Mã Vaccine");
		...
		dtmthongkenhaphang.addColumn("Tên Vaccine");
		JScrollPane scrollPane = new JScrollPane();
		...
		JLabel lblNewLabel_20 = new JLabel("Số Vaccine Đã Nhập");
	...
	private void nhanvien() {
		...
		//////////////////////////////
		//them đơn vị tiêm
		lblDonViPhuTrachTiem = new JLabel("Đơn vị tiêm");
		...
		///////////
		dtmnhanvien.addColumn("Đơn vị tiêm");
		///////////
	...
	private void nhaxuatban() {
		...
		lblTennhaSanXuat = new JLabel("Tên Nhà Cung Cấp");
		...
		lblTennhaSx_2 = new JLabel("Số Điện Thoại");
		...
		btnreloadnSX = new JButton("Tải Lại");
		...
		lblTimKiemnSx = new JLabel("Tìm Kiếm");
		...
		dtmnhaSx.addColumn("Mã Nhà Cung Cấp");
		dtmnhaSx.addColumn("Tên Nhà Cung Cấp");
		dtmnhaSx.addColumn("Địa Chỉ");
		dtmnhaSx.addColumn("Số Điện Thoại");
	...
	private void nguoidan() {
		...
		lblTenNguoiDan = new JLabel("Tên Người Dân/độ tuổi");
		...
		*/
		...
		////thêm mã đăng ký tiêm
		lblNewLabel_3 = new JLabel("Số CCCD");
		...
		lbldiachiNguoidan = new JLabel("Địa Chỉ");
		...
		lblgioitinhNguoiDan = new JLabel("Giới Tính");
		...
		lblSdtnguoidan = new JLabel("Số điện thoại");
		...
		btnthemnguoidan = new JButton("Thêm");
		...
		btnsuanguoidan = new JButton("Sửa");
		...
		btnxoanguoidan = new JButton("Xoá");
		...
		btnTimkiemnguoidan = new JButton("Tìm");
		btnTimkiemnguoidan.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				if (!isNumber(txtTimkiemnguoidan.getText())) {
					JOptionPane.showMessageDialog(null, "Tìm kiếm mã người dân phải là số");
					return;
				}
		...
		dtmnguoidan.addColumn("Mã Người Dân");
		dtmnguoidan.addColumn("Họ Và Tên");
		dtmnguoidan.addColumn("Giới Tính");
		dtmnguoidan.addColumn("Số Điện Thạoi");
		dtmnguoidan.addColumn("Địa Chỉ");
		
		////////////////////
		dtmnguoidan.addColumn("Nám sinh");
		///////////////////
		
		tablenguoidan = new MyTable(dtmnguoidan);
		scrollPane_1.setViewportView(tablenguoidan);
		JPopupMenu popupMenu = new JPopupMenu();
		mntmNewMenuItem = new JMenuItem("Test-Cấp thẻ");
...
//						System.out.println(tv);
						...
						int a = JOptionPane.showConfirmDialog(null, "Thành Viên này chưa có thẻ tài khoản bạn có muốn thêm thẻ không", "", JOptionPane.YES_NO_OPTION);
	...
	private void pntacgia() {
		...
		lblTentacgia = new JLabel("Ngày Đăng Ký");
		...
		//lựa chọn người dân nào đăng ký
		////////////////
		...
		lblnamsinh = new JLabel("Ngày muốn tiêm");
		...
		////////////////////////
		lbldiadiemmuontiem = new JLabel("Gói Tiêm");
		...
		dtmtacgia.addColumn("Mã Đăng Ký Tiêm");
		dtmtacgia.addColumn("Ngày Đăng Ký ");
		dtmtacgia.addColumn("Gói Tiêm");
		dtmtacgia.addColumn("Loại Vắc-xin đ/k");
		
		dtmtacgia.addColumn("Mã CCCD1");
		dtmtacgia.addColumn("Ngày muốn tiêm");
	...
	private void pnVaccine() {
		...
		lblTenVaccine = new JLabel("Tên Vaccine");
		...
		lblNewLabel_2 = new JLabel("Mã Nhà Cung Cấp");
		lblNewLabel_2.setFont(new Font("Tahoma", Font.BOLD, 15));
		lblNewLabel_2.setBounds(12, 111, 132, 34);
		panel.add(lblNewLabel_2);

		lblNewLabel_3 = new JLabel("Hạn sử dụng");
		lblNewLabel_3.setFont(new Font("Tahoma", Font.BOLD, 15));
...
//đang fix
		...
		dtmVAccine.addColumn("Mã Vaccine");
		dtmVAccine.addColumn("Tên Vaccine");
		dtmVAccine.addColumn("Mã Nhà Khoa Học");
		dtmVAccine.addColumn("Mã Nhà Cung Cấp");
		dtmVAccine.addColumn("Mã Loại");
		dtmVAccine.addColumn("Năm Sản Xuất");
		dtmVAccine.addColumn("Số Lượng");
		dtmVAccine.addColumn("Mã Kệ");
		dtmVAccine.addColumn("Ảnh");
	...
	private void trangchu() {
		...
		lblNewLabel = new JLabel("QUẢN LÝ THÔNG TIN TIÊM VẮC-XIN");
	...
	public void addEvent() {
		...
		tabletacgia.addMouseListener(new MouseListener() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if (i >= 0) {
					...
					*/
					//đang fix (nagyf đăng ký chưa chạy theo khi click chuột
		...
		///////////////////////////////////////////////////
		//////////////// THÊM SỬA XOÁ ĐỌC GIẢ //////////////////////////txtmaCCCD.getValue().toString()
		/////////////////////////////////////////////////
		...
		btnthemphieuTiem.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (!TheThuVienDAL.check(madocgia)) {
					JOptionPane.showMessageDialog(null, "người dnnày chưa có thẻ quản lý, vui lòng đăng kí thẻ quản lý với admin");
					return;
				}
				*/
...
//chú ý
				...
				if (!isNumber(txtmapt.getText())) {
					JOptionPane.showMessageDialog(null, "Mã Vaccine sai");
					return;
				}
				if (!isNumber(txtmapt.getText())) {
					JOptionPane.showMessageDialog(null, "Mã Vaccine sai");
