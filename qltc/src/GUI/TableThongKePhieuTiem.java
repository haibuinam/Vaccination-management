...
public class TableThongKePhieuTiem extends JDialog {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					TableThongKePhieuTiem frame = new TableThongKePhieuTiem();
	...
	public TableThongKePhieuTiem() {
		...
		dtmthongkephieumuon.addColumn("Mã CTPTiem");
		dtmthongkephieumuon.addColumn("Mã Phiếu Tiêm");
		dtmthongkephieumuon.addColumn("Mã Vắc-xin");
		dtmthongkephieumuon.addColumn("Ngày Tiêm");
		dtmthongkephieumuon.addColumn("Ngày hết hạn");
		...
		JLabel lblNewLabel = new JLabel("THỐNG KÊ VACCINE ĐÃ TIÊM");
		lblNewLabel.setForeground(Color.RED);
		lblNewLabel.setFont(new Font("Tahoma", Font.BOLD, 20));
		lblNewLabel.setBounds(201, 29, 350, 69);
