...
public class LoaiSachDAL {
	...
	public static ArrayList<LoaiDTO> getdanhsachLoai() {
		try {
	...
	public static int themloaisach(LoaiDTO loai) {
		int i = -1;
	...
	public static int sualoaisach(LoaiDTO loai) {
		int i = -1;
	...
	public static int xoaloaisach(LoaiDTO loai) {
		int i = -1;
