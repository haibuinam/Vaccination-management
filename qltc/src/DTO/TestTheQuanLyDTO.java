...
public class TestTheQuanLyDTO {
	...
	public TestTheQuanLyDTO(int maTheThuVien, int madocgia, String tendocgia, String ngayBatDau, String ngayKetThuc) {
		super();
		MaTheThuVien = maTheThuVien;
		NgayBatDau = ngayBatDau;
		NgayKetThuc = ngayKetThuc;
	...
	public TestTheQuanLyDTO() {
		super();
		// TODO Auto-generated constructor stub
	}

	public TestTheQuanLyDTO(int maTheThuVien, String ngayBatDau, String ngayKetThuc, String ghiChu) {
		super();
		MaTheThuVien = maTheThuVien;
		NgayBatDau = ngayBatDau;
		NgayKetThuc = ngayKetThuc;
